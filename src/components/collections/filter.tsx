...
const buttonStyle =
  "bg-transparent hover:bg-background-hover w-full px-3 py-1 text-base font-normal [&[data-expanded]]:bg-background-hover";
...
export default function Filter(props: FilterProps) {
  ...
  return (
    <div class="pb-40px scrollbar-hide relative flex h-[cal(100%-190px)] flex-col overflow-auto overflow-y-auto overflow-x-hidden duration-200">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div class="flex w-full flex-col px-3">
                        <For
                          each={item.kinds.filter((kind) =>
                            kind.name.includes(searchStore[idx()]),
                          )}
                        >
                          {(i, idx_) => (
