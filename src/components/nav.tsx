...
export default function Nav() {
  return (
    <div class="t-0 l-0 absolute z-[5] w-full">
      <nav class="fixed z-[500] m-auto flex w-full items-center justify-between border-b-0 border-[#2a2a2a] bg-[#13131353] px-5 pb-2 pt-3 transition max-[950px]:px-[10px] max-[950px]:pt-3">
        ...
        <div class="mb-[3px] flex  items-center justify-end space-x-2 font-normal">
          <button class="button-default rounded-full">
            <Bell size={24} />
          </button>
          <button class="button-default text-sm">Buy Solana</button>
          <button class="button-default px-3 text-sm ">FeedBack ?</button>
          <button class="button-default text-primary border-[c77100] bg-[#432a11] text-sm">
            Connect Wallet
          </button>
        </div>
      </nav>
