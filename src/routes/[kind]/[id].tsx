					...
					<div class="collection-layout gap-10px w-100% flex flex-col ">
						...
						<div class="collection-bottom lt-lg:h-auto flex h-[calc(100vh-180px)] w-full ">
							<div class="collection-filter">
								<div class="rounded-tl-10px rounded-bl-10px lt-lgg:hidden flex h-full w-[280px] flex-row transition-all border-border border-r-none border">
							...
							<div class="collection-items-and-chart flex flex-grow flex-col ">
								...
								<div class="items-activity-charts border-border flex h-[calc(40vh-87px)] flex-col overflow-hidden border-b border-l border-t lt-lg:hidden">
							...
							<div class="activities w-330px border-border lt-lg:hidden rounded-tr-10px rounded-br-10px flex flex-row overflow-hidden border-b border-l border-r border-t lt-lg:hidden">
